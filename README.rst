...
The ``circtools`` package is written in Python 3 (supporting Python 3.7 - 3.12). It requires only a small number of external dependencies, namely standard bioinformatics tools:
